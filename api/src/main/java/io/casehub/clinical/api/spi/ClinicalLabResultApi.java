...
@McpDomain(value = "clinical/lab-results", app = "clinical", basePath = "/trials/{trialId}/sites/{siteId}/patients/{enrollmentId}/lab-results", summary = "Laboratory test result recording and queries")
