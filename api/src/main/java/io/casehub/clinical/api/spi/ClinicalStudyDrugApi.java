...
@McpDomain(value = "clinical/study-drug", app = "clinical", basePath = "/trials/{trialId}/sites/{siteId}/patients/{enrollmentId}/study-drug", summary = "Investigational drug dispensing and accountability")
